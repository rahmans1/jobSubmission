...
parser.add_argument("-s", dest="src", action="store", required=False, default="/w/work/halla/moller12gev/rahmans/REMOLL/remoll_version", help="source folder where simulation directory exists")
...
jsubf.write("source /apps/root/6.18.04/setroot_CUE \n")
...
macro=os.path.realpath("/scratch")+"/"+args.gen+"_${SLURM_JOBID}_${SLURM_ARRAY_TASK_ID}.mac"
...
jsubf.write("\cp -rf "+args.src+"/"+args.version+" "+os.path.realpath("/scratch")+"\n")
jsubf.write("cd "+os.path.realpath("/scratch")+"/"+args.version+" \n")
