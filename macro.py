...
if not sys.argv[1]:
	home = "/home/rahmans/projects/def-jmammei/rahmans/remoll-root/remoll"
else:
	home= sys.argv[1]
if not sys.argv[2]:
	macro= "/home/rahmans/projects/def-jmammei/rahmans/jobSubmission/rasterStudy/macro"
else:
	macro= sys.argv[2]
if not sys.argv[3]:
        jsub= "/home/rahmans/projects/def-jmammei/rahmans/jobSubmission/rasterStudy/jsub"
else:
        jsub = sys.argv[3]
if not sys.argv[4]:
	field= "/home/rahmans/projects/def-jmammei/rahmans/remoll-root/remoll/map_directory"
else:
	field= sys.argv[4]
if not sys.argv[5]:
	geometry = "/home/rahmans/projects/def-jmammei/rahmans/remoll-root/remoll/geometry"
else:
	geometry= sys.argv[5]	
if not sys.argv[6]:   
	scratch= "/scratch/rahmans/scratch/rasterStudy"
else:
	scratch= sys.argv[6]
if not sys.argv[7]:
        tmp= "/scratch/rahmans/tmp/rasterStudy"
else:
        tmp= sys.argv[7]
if not sys.argv[8]:
...
for i in runrange:
  ...
  jsubf.write("source /home/rahmans/projects/def-jmammei/rahmans/bin/cedar_env.sh\n")
